...
use crate::{
    ...
    models::portfolio::{
        AddPortfolioItemRequest, CreatePortfolioRequest, Portfolio, PortfolioDetailResponse,
        PortfolioItem, UpdatePortfolioItemRequest, UpdatePortfolioRequest,
    },
...
impl PortfolioService {
    ...
    pub async fn list(&self, user_id: Uuid) -> Result<Vec<Portfolio>, AppError> {
        self.repository
